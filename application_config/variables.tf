...
variable "api_key_secret_id" {
  type        = string
  description = "(Required) SECRET ID fot the API Key I key for web app to talk to SaaS platform."
}
...
variable "tfe_workspace" {
  type        = string
  description = "(Required) TFC Workspace name to get information"
}

variable "playbook_repository" {
  type        = string
  description = "(Required) The URI of Ansible Playbook that should"
}

variable "ec2_role_name" {
  type        = string
  description = "(Required) The name of IAM role for EC2 instance Profile"
}
